...
<!-- 
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/core-style4.css')}}">
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-3 mx-auto">
      ...
      <ul class="list-unstyled">
        <li><a href="{{route('login')}}" class="font-rale">My Account</a></li>
        <li><a href="{{route('show.cart')}}" class="font-rale">Cart</a></li>
