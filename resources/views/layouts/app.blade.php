...
<!-- 
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/style-15.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/imagecarouselspecial.css')}}">


    <!-- Store Page  Css-->

    <link rel="stylesheet" href="{{asset('frontend/css/core-style2.css')}}">
...
<!--/.Footer-->
    ...
    <script src="{{asset('frontend/js/imagecarouselspecial.js')}}"></script>
