...
class AdminProductController extends Controller
{
  ...
  public function store(Request $request){
    ...
    if ($image_one && $image_two && $image_three) {
     ...
     Image::make($image_one)->save('./media/product/'.$image_one_name);
     $data['image_one'] = './media/product/'.$image_one_name;

     $image_two_name = hexdec(uniqid()).'.'.$image_two->getClientOriginalExtension();
     Image::make($image_two)->save('./media/product/'.$image_two_name);
     $data['image_two'] = './media/product/'.$image_two_name;


     $image_three_name = hexdec(uniqid()).'.'.$image_three->getClientOriginalExtension();
     Image::make($image_three)->save('./media/product/'.$image_three_name);
